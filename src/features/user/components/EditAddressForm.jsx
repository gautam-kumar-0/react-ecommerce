...
export const EditAddressForm = ({show, setShow, index, address}) => {
	const toggleShow = () => {
		setShow(!show);
	};
	...
	const addAddress = (e) => {
		...
		dispatch(updateUserAsync({update: {addresses: newAddresses}, userId}));
		setShow(false);
	};
	console.log("Edit address loaded:", address, index);
				...
				<div className="flex gap-6 p-1">
					<label className="flex gap-2 text-sm font-medium ">
						<input
							...
							name="type"
							value={"Home"}
							defaultChecked={address?.type === "Home"}
							className="peer"
						/>
					...
					<label className="flex gap-2 text-sm font-medium ">
						<input
							...
							name="type"
							value={"Work"}
							defaultChecked={address?.type === "Work"}
							className="peer"
						/>
